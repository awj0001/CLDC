from inventoryScreen1 import inventory1
from inventoryScreen1 import determineInventory1
import pygame
...
class Sprite:
    ...
    def render(self, screen, direction):
        ...
        if (air > 4000):
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1800, 950))
        elif (air > 3000):
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1700, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1800, 950))
        elif (air > 2000):
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1600, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1700, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1800, 950))
        elif (air > 1000):
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1500, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1600, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1700, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1800, 950))
        else:
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1400, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1500, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1600, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1700, 950))
            screen.blit(pygame.transform.scale(self.bubble, (100, 100)), (1800, 950))
...
def game1(screen, playerGender):
    ...
    while gameContinue:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if keys[pygame.K_LEFT] and keys[pygame.K_UP] and player.x < -200 and player.y < -100:
                    ...
                    playerY += 20
                    direction = 'northeast'
                elif keys[pygame.K_RIGHT] and keys[pygame.K_DOWN] and player.x > -5750 and player.y > -3700:
                    playerX += -20
                    playerY += -20
                    direction = 'southeast'
                elif keys[pygame.K_LEFT] and player.x < -200:
                    playerX += 25
                    direction = 'west'
                    timeLeft = 0
                    lookLeft = 1
                elif keys[pygame.K_RIGHT] and (playerX + player.x) > -5750:
                    playerX += -25
                    direction = 'east'
                    lookLeft = 0
                elif keys[pygame.K_UP] and player.y < -200:
                    playerY += 25
                    direction = 'north'
                elif keys[pygame.K_DOWN] and player.y > -3700:
                    playerY += -25
                    direction = 'south'
                elif keys[pygame.K_i]:
                    inventory1(screen, inventoryItems)
        ...
        player.x += playerX
        player.y += playerY
        determineInventory1(player.x, player.y, inventoryItems)
